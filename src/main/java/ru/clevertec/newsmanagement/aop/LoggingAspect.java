...
public class LoggingAspect {
    ...
    /**
     * A pointcut expression for methods in the service layer (i.e. classes in the ru.clevertec.newsmanagement.service.impl package).
     */
    ...
    /**
     * A pointcut expression for methods in the controller layer (i.e. classes in the ru.clevertec.newsmanagement.controller package).
     */
